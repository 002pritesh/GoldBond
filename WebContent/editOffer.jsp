...
<body>
 <h2><a class="back" href="allOfferEditOffer.jsp"><i class='fas fa-arrow-circle-left'> Back</i></a></h2>
<%
...
try{
	...
	ResultSet rs=st.executeQuery("select * from offersname where id='"+id+"'");
	while(rs.next()){
		
%>

<form action="editOfferAction.jsp"method="post">
